namespace Recipe_Book.Forms
{
    partial class CreateRecipeForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            label1.Size = new Size(228, 51);
            label1.TabIndex = 3;
            label1.Text = "New Recipe";
            ...
            BtnAdd.FlatAppearance.MouseOverBackColor = Color.FromArgb(24, 119, 242);
            BtnAdd.FlatStyle = FlatStyle.Flat;
            BtnAdd.Font = new Font("Segoe UI", 11F, FontStyle.Bold);
            BtnAdd.ForeColor = Color.White;
            BtnAdd.Location = new Point(501, 573);
            BtnAdd.Name = "BtnAdd";
